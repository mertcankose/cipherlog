...
import {navigatePush} from '@navigation/RootNavigation';

const {width} = Dimensions.get('screen');

const Indicator = ({navigation, data, scrollx}) => {
  ...
  return (
    <View style={styles.indicatorContainer}>
      ...
      <TouchableOpacity style={styles.skipButton} onPress={passOnboarding}>
