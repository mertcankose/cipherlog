import {Header, SecretItem, NoteButton, NoteText, Loading, NoteStatusBar} from '@components';
import {useContext, FC, useRef, useMemo, useCallback, useEffect, useState, Fragment} from 'react';
import {
  FlatList,
  View,
  StyleSheet,
    ...
    <Fragment>
      ...
      <View
        ...
        <GestureHandlerRootView style={{flex: 1, paddingBottom: 24}}>
          ...
          <View style={styles.notesBottomSection}>
            {notes?.length > 0 && (
